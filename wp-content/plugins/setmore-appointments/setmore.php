...
<main class="container-mod">
      ...
      <input type="hidden" id="setmore_booking_page_version" name="setmore_booking_page_version" value="<?php echo $savedBookingPageVersion ?>" id="setmore_booking_page_version">
      <input type="hidden" id="setmore_booking_page_url" name="setmore_booking_page_url" value="<?php echo $savedBookingPageUrl ?>" id="setmore_booking_page_url">
      <input type="hidden" id="languageOption" name="languageOption" value="<?php echo $savedBookingPageLang  ?>" id="languageOption">
      </section>
      <section id= "connectBlock">
          <section class="hero-wrap" id="connect">
            <article>
              ...
              <input id="signup" value="Signup" type="button" siteUrl="<?php echo $scriptUrl;?>" class="btn-primary" data-aos="fade-up"/>
              
              <input id="login" type="button" value="Login" class="btn-secondary" data-aos="fade-up" siteUrl="<?php echo $scriptUrl;?>"/>
            ...
            <div class="options-wrap fx">
              ...
              <div class="sm-url-wrap mr-2">
                <div class="sm-url-edit text-truncate" id="edit_booking_page_url" style="display:none">
                  <input id="text_booking_page_url" type="text" style="width: 450px" value="<?php echo$savedBookingPageUrl?>" />
                </div>
                <a class="sm-url text-truncate" id="booking_page_url" target="_blank" href="<?php echo$savedBookingPageUrl?>?lang=<?php echo $savedBookingPageLang?>">
